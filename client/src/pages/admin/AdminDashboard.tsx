...
const AdminDashboard = () => {
  ...
  return (
    <div className="w-full min-h-screen h-full bg-green-700 flex items-center flex-col px-[6rem] relative">
      <div className="w-full  text-center ">
        <div className=" flex justify-between  h-[6rem] items-center w-full border-2">
        ...
        <div className="flex gap-4 mt-[2rem]">
          <div className="relative w-[50%] grid place-content-center place-items-center  overflow-hidden bg-transparent">
      ...
      {showModal && (
        <Modal selectedPlot={selectedPlot} setShowModal={setShowModal} />
      )}
    </div>
  );
};
